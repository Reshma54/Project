...
public class UpdateCheck extends JFrame implements ActionListener {
	...
	UpdateCheck(){
		...
		ImageIcon i1 = new ImageIcon("G:\\ITPJAVAPro\\HotelManagementSystem\\src\\icons/nine.jpg");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource() == check) {
			...
			try {
				...
				Conn c= new Conn();
				c.st.executeUpdate( "Update customer set room = '"+room+"', name = '"+name+"' ,checkintime = '"+checkin+"' , deposit = '"+deposit+"'  where number='"+number+"' "); 
