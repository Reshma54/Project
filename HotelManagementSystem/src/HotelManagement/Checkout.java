...
public class Checkout extends JFrame implements ActionListener {
	...
	Checkout() {
		 ...
		 add(lblid);
			...
			ImageIcon i1=new ImageIcon("G:\\ITPJAVAPro\\HotelManagementSystem\\src\\icons//tick.png");
			...
			add(tick);
			 ...
			 add(back);
				...
				ImageIcon i4=new ImageIcon("G:\\ITPJAVAPro\\HotelManagementSystem\\src\\icons\\sixth.jpg");
				Image i5= i4.getImage().getScaledInstance(400 , 250, Image.SCALE_DEFAULT);
				ImageIcon i6 = new ImageIcon(i5);
				JLabel image = new JLabel(i6);
				image.setBounds(360 , 50, 400, 250);
				add(image);
